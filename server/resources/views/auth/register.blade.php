              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input name="unit_id" type="text" class="form-control form-control-user @error('unit_id')is-invalid @enderror" id="exampleUnitId" placeholder="Unit Id">
                    @error('unit_id')
                      <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="col-sm-6">
                    <input name="class_name" type="text" class="form-control form-control-user @error('class_name')is-invalid @enderror" id="exampleClassName" placeholder="Class">
                    @error('class_name')
                      <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                  </div>
